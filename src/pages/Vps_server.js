              ...
              <div className="col-md-7 col-lg-6">
                <div className="hero-content-wrap text-white">
                  <h1 className="text-white">
                    20x Faster Virtual Private Server (VPS) Hosting
                  </h1>
                  <p className="lead">
                    vps, give you the cost benefits with the performance and
                    control of Dedicated Hosting. VPS is a cost-effective Server
                    option which allows for your to have dedicated resources.
                  </p>
                  <a
            ...
            <div className="row justify-content-center">
              <div className="col-md-9 col-lg-8">
                <div className="section-heading text-center mb-4">
                  <h2>Choose Your Virtual Private Server Plan</h2>
                  <p className="lead">
                    Professional VPS Service at an affordable price. 
                  </p>
                </div>
              </div>
            </div>
            <div className="row align-items-center justify-content-md-center justify-content-center">
              <div className="col-lg-4 col-md-6 col-sm-8">
                <div className="popular-price text-center bg-white single-pricing-pack-2 price-2 mt-4 rounded border">
                  <h6 className="mb-4">Tier 1</h6>
                  <div className="pricing-price pb-4">
                    <div className="h3 mb-0">
                      $18.99 <span className="price-cycle h4">/mo</span>
                      <br />
                    </div>
                    <div>
                      <span className="pricing-onsale ">
                        Previously -
                        <span className="badge color-3 color-3-bg priceTextVps">
                          $29.99
                        </span>
                      </span>
                    </div>
                  ...
                  <div className="pricing-content">
                    <ul className="list-unstyled pricing-feature-list p-4 mb-0">
                      ...
                      <li>
                        <span>1 TB</span>&nbsp; Bandwidth
                      </li>
                      <li>
                        <span>1 IP</span>&nbsp; Address
                      </li>
                    </ul>
                    <a
                      href="https://cp.idatahost.com/login"
              ...
              <div className="col-lg-4 col-md-6 col-sm-8">
                <div className="popular-price text-center bg-white single-pricing-pack-2 price-2 mt-4 rounded border">
                  <h6 className="mb-4">Tier 2</h6>
                  <div className="pricing-price pb-4">
                    <div className="h3 mb-0">
                      $29.99 <span className="price-cycle h4">/mo</span>
                      <br />
                    </div>
                    <div>
                      <span className="pricing-onsale ">
              ...
              <div className="col-lg-4 col-md-6 col-sm-8">
                <div className="popular-price text-center bg-white single-pricing-pack-2 price-2 mt-4 rounded border">
                  <h6 className="mb-4">Tier 3</h6>
                  <div className="pricing-price pb-4">
                    <div className="h3 mb-0">
                      $59.99 <span className="price-cycle h4">/mo</span>
                      <br />
                    </div>
                    <div>
                      <span className="pricing-onsale ">
                  ...
                  <div className="pricing-content">
                    <ul className="list-unstyled pricing-feature-list p-4 mb-0">
                      ...
                      <li>
                        <span>3 TB</span>&nbsp; Bandwidth
                      </li>
                      <li>
                        <span>2 IP</span>&nbsp; Address
                      </li>
                    </ul>
                    <a
                      href="https://cp.idatahost.com/login"
            ...
            <div className="row justify-content-center">
              <div className="col-md-9 col-lg-8">
                <div className="section-heading text-center mb-5">
                  <h2>VPS Service Hosting Features</h2>
                  <p className="lead">
                    VPS Hosting performance, flexible management levels, easy-to-use
                    features
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-6 col-lg-6">
                <div className="cta-new-wrap">
                  <div className="feature-feature-list py-3">
                    ...
                    <h5 className="mb-2">Easy Scalability</h5>
                    <p>
                      Upgrade or downgrade your VPS Service anytime for limited Downtime.
                  ...
                  <div className="feature-feature-list py-3">
                    ...
                    <p>
                      We can guarantee you an excellent up time experience and loading time
                      is very fast. iDataHost assurance you Network Up Time.
                    </p>
                  </div>
                  <div className="feature-feature-list py-3">
                    ...
                    <p>
                    Our Dedicated Server security maintains all security rules. So, the VPS  performance is the best and runs smoothly. 
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-6 col-lg-6">
                <div className="cta-new-wrap">
                  <div className="feature-feature-list py-3">
                    ...
                    <p>
                      VPS service performance, protection, speed and access for your 
                      websites you need an IP address. Which allowing you to connect your 
                      VPS service device. 
                    </p>
                  </div>
                  <div className="feature-feature-list py-3">
            ...
            <div className="row justify-content-center">
              <div className="col-md-9 col-lg-8">
                <div className="section-heading text-center mb-5">
                  ...
                  <p>
                    Some common questions answer. Still have
                ...
                <div id="accordion" className="accordion faq-wrap">
                  <div className="card mb-3">
                    ...
                    <div
                      ...
                      <div className="card-body white-bg">
                        <p>
                        Virtual Private Server (VPS) refers to partitioning a dedicated server into multiple ones. Each VPS has its own Operating System (OS). VPS is a server that is a virtual machine. While you will share some hardware resources with other VPS from one physical server, so they are isolated, unable to interfere, and can be separately rebooted.  
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card my-3">
                    ...
                    <div
                      ...
                      <div className="card-body white-bg">
                        <p>
                        For web hosting accounts, users are guaranteed for the resources on their VPS server. The benefits of VPS are:
1.	Reliability
2.	Complete control
3.	Scalability
4.	Security
5.	Cost-effective
If you do not share the operating system with any other users, you will get better protection for your website files.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="card mt-3">
                    ...
                    <div
                      ...
                      <div className="card-body white-bg">
                        <p>
                          VPS Hosting service best for bloggers, Hosting reseller,
                          E-commerce owner and web Developers. iDataHost offer best
                          security, High performance, flexibility server. Where full
