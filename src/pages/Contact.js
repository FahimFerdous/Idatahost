                ...
                <div className="card single-promo-card text-center p-3 my-3">
                  <div className="card-body">
                    ...
                    <div className="pt-2 pb-3">
                      ...
                      <p className="mb-0">
                        Open a ticket for getting quick response. 
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="card single-promo-card text-center p-3 my-3">
                  <div className="card-body">
                    ...
                    <div className="pt-2 pb-3">
                      ...
                      <p className="mb-0">
                        We endeavour to answer all enquiries within short time.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="contact-us-form-wrap gray-light-bg position-relative">
                  ...
                  <div className="contact-us-content primary-bg text-white shadow-lg mt-5 mt-md-0 mt-lg-0">
                    ...
                    <ul className="contact-info-list mt-3">
                      ...
                      <li className="d-flex py-3">
                        <div className="contact-icon mr-3">
                          <span className="fas fa-phone color-accent"></span>
                        </div>
                        <div className="contact-text">
                          <h6 className="mb-1 text-white font-weight-normal">
                          +(121)35100797
                          </h6>
                          <small> call for technical support only </small>
                        </div>
                      </li>
                    </ul>
                    <ul className="list-inline social-list-default background-color social-hover-2 mt-2">
                      ...
                      <li className="list-inline-item">
                        <a className="facebook" href="https://www.facebook.com/idatahost">
                          <i className="fab fa-facebook"></i>
                        </a>
                      </li>
                      <li className="list-inline-item">
                        <a className="linkedin" href="https://www.linkedin.com/company/idatahost">
                          <i className="fab fa-linkedin-in"></i>
                        </a>
                      </li>
                      <li className="list-inline-item">
                        <a className="instagram" href="https://www.instagram.com/idata_host/">
