            ...
            <div className="row align-items-center">
              <div className="col-md-6 col-lg-6">
                <div className="hero-content-wrap text-white position-relative">
                  ...
                  <p className="lead">
                    WordPress hosting made easy & affordable, choose a
                    fine-tuned web hosting services solution for successful
              ...
              <div className="col-md-9 col-lg-8">
                <div className="section-heading text-center mb-5">
                  ...
                  <p className="lead">
                    ...
                    competencies through client-centered core competencies.
                    Enthusiastically provide access.
                  </p>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-md-6 col-lg-3">
                <div className="feature-feature-list p-3 text-center">
                  ...
                  <h5 className="mb-2">100% Network Uptime</h5>
              ...
              <div className="col-md-6 col-lg-4">
                <div className="features-box border p-4 rounded">
                  ...
                  <div className="features-box-content">
                    <h5>Ease of use</h5>
                    <p>
                      If you're a pro or a newcomer, our WordPress Hosting Plans
              ...
              <div className="col-md-6 col-lg-4">
                <div className="features-box border p-4 rounded">
                  ...
                  <div className="features-box-content">
                    ...
                    <p>
                      Your WordPress site is protected thanks to LiteSpeed's
                      cache engine, Cloudflare's protection, and an SSL
                      certificater.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-md-6 col-lg-4">
                <div className="features-box border p-4 rounded">
                  ...
                  <div className="features-box-content">
                    ...
                    <p>
                      you can easily install WordPress with a single click and
              ...
              <div className="col-md-6 col-lg-4">
                <div className="features-box border p-4 rounded">
                  ...
                  <div className="features-box-content">
                    ...
                    <p>
                      We take regular offsite backups of your websites and store
                      them for up to 30 days, ensuring that your hard work is
                      protected. From your control panel, you can restore your
                      data at any time.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-md-6 col-lg-4">
                <div className="features-box border p-4 rounded">
                  ...
                  <div className="features-box-content">
                    ...
                    <p>
                      In less than an hour, we'll pass your website to us! Our
                      migration specialists can migrate your current websites
                      and emails for free, with no downtime.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="features-box border p-4 rounded">
                  ...
                  <div className="features-box-content">
                    ...
                    <p>
                      ...
                      https for added protection and SEO.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div id="accordion" className="accordion faq-wrap">
                  ...
                  <div className="card my-3">
                    ...
                    <div
                      ...
                      <div className="card-body white-bg">
                        <p>
                          WordPress hosting is a shared hosting service that
                          includes the WordPress CMS pre-installed. It also
                          includes several WordPress plugins that enable users
                          to create their website right away!
                        </p>
                      </div>
                    </div>
                  </div>
