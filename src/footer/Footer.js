        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 col-lg-4 mb-4 mb-md-4 mb-sm-4 mb-lg-0">
              ...
              <br />
              <p>
                We serve hosting, domain registering, and managing service for
                you. Most affordable and easily managed.
              </p>
              ...
              <div className="row mt-0">
                ...
                <div className="col-sm-6 col-md-3 col-lg-3 mb-4 mb-sm-4 mb-md-0 mb-lg-0">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="#">High-Performance VPS</a>
                    </li>
                    <li>
                      <a href="#">IDH VPS Server</a>
                    </li>
                    <li>
                      <a href="#">Virtual Dedicated Server</a>
                    </li>
                    <li>
                      <a href="#">VPS Server</a>
                    </li>
                    <li>
                      <a href="#">IDH Cloud Server</a>
                    </li>
                  </ul>
                </div>
              ...
              <div className="row mt-0">
                ...
                <div className="col-sm-6 col-md-3 col-lg-3 mb-4 mb-sm-4 mb-md-0 mb-lg-0">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="#">Free Migrate Wordpress</a>
                    </li>
                  </ul>
                </div>
